            ...
            <div class="box-body">
			  ...
			  <div class="form-group">
                  <div class="input-group">
                    ...
                    <select id="sem2" class="form-control select2" onchange="getClassViaSem();"  data-placeholder="Select Class Days"
                        style="width: 100%;">
				...
				<div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa  fa-calendar-o"></i></span>
                    <select id="year2" class="form-control select2" onchange="getClassViaYear();" data-placeholder="Select Class Days"
                        style="width: 100%;">
                  <option>2018</option>
                  <option>2017</option>
                </select>
